...
namespace SensorToolkit
{
    ...
    {
        // The rig won't try to steer around objects in this list.
        public GameObject[] IgnoreList;

        // Lower numbers mean the rig will move closer to obstacles.
        [Range(0.1f, 4f)]
        public float AvoidanceSensitivity = 1f;
        // The max distance that can be steered from the target direction.
        [Range(1f, 2f)]
        ...
        // If assigned the steering rig will control the movement of this rigid body.
