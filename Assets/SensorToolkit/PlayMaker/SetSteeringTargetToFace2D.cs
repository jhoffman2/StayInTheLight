...
namespace SensorToolkit.PlayMaker
{
    ...
    public class SetSteeringTargetToFace2D : SensorToolkitComponentAction<SteeringRig2D>
    {
        ...
        void doCheck()
        {
            ...
            {
                steeringRig2D.ClearDirectionToFace();
                steeringRig2D.FaceTowardsTransform = gameObjectToFace.Value.transform;
            }
            else
            {
                steeringRig2D.FaceTowardsTransform = null;
                steeringRig2D.DirectionToFace = directionToFace.Value;
            }
        }
    }
}
