...
namespace SensorToolkit
{
    ...
    {
        // Any GameObject in this list will not be detected by this sensor, however it may still block line of sight.
        public GameObject[] IgnoreList;

        // When set to try the sensor will only detect objects whose tags are in the 'TagFilter' array.
        public bool EnableTagFilter;

        // Array of tags that will be detected by the sensor.
        [TagSelector]
        ...
        private GameObject nearestToPointWithTag(IEnumerable<GameObject> gos, Vector3 point, string tag)
        {
            GameObject nearest = null;
            var nearestDistance = 0f;
            var gosEnumerator = gos.GetEnumerator();
        ...
        private T nearestToPointWithTagAndComponent<T>(IEnumerable<GameObject> gos, Vector3 point, string tag) where T : Component
        {
            T nearest = null;
            var nearestDistance = 0f;
            var gosEnumerator = gos.GetEnumerator();
        ...
        private Component nearestToPointWithTagAndComponent(IEnumerable<GameObject> gos, Vector3 point, string tag, Type t)
        {
            Component nearest = null;
            var nearestDistance = 0f;
            var gosEnumerator = gos.GetEnumerator();
        ...
        private GameObject nearestToPointWithNameAndTag(IEnumerable<GameObject> gos, Vector3 point, string name, string tag)
        {
            GameObject nearest = null;
            var nearestDistance = 0f;
            var gosEnumerator = gos.GetEnumerator();
        ...
        private T nearestToPointWithNameAndTagAndComponent<T>(IEnumerable<GameObject> gos, Vector3 point, string name, string tag) where T : Component
        {
            T nearest = null;
            var nearestDistance = 0f;
            var gosEnumerator = gos.GetEnumerator();
        ...
        private Component nearestToPointWithNameAndTagAndComponent(IEnumerable<GameObject> gos, Vector3 point, string name, string tag, Type t)
        {
            Component nearest = null;
            var nearestDistance = 0f;
            var gosEnumerator = gos.GetEnumerator();
